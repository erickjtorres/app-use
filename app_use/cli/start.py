...
def _get_android_system_packages() -> List[str]:
    ...
    return [
        ...
        'com.android.inputmethod', 'com.android.documentsui', 'com.android.internal',
        'com.google.android.overlay', 'com.android.backupconfirm', 'com.android.bips',
...
def _get_ios_simulator_apps(device_id: str) -> List[Dict[str, str]]:
    ...
    result = subprocess.run(['xcrun', 'simctl', 'listapps', device_id], 
                           capture_output=True, text=True, timeout=20)
    if result.returncode == 0:
        # Parse plist output and extract app information
...
def _run_setup_wizard() -> Optional[Dict]:
    ...
    from .devices import get_devices_for_platform, get_apps_for_device
