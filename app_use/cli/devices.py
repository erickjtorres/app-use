...
def _get_android_system_packages() -> List[str]:
    ...
    return [
        ...
        'com.android.server.', 'com.qualcomm.', 
...
def _get_ios_simulator_apps(device_id: str) -> List[Dict[str, str]]:
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            plutil_result = subprocess.run(['plutil', '-convert', 'json', '-o', '-', '-'],
            ...
            if plutil_result.returncode == 0:
                ...
                skip_bundles = {
                    'com.apple.Preferences', 'com.apple.springboard', 'com.apple.WebKit.WebContent',
                    'com.apple.mobilesafari.SafariViewService', 'com.apple.CoreSimulator.SimulatorTrampoline',
                    'com.apple.AccountAuthenticationDialog', 'com.apple.AuthKit.AuthKitUIService',
                    'com.apple.datadetectors.DDActionsService', 'com.apple.SIMSetupUIService',
