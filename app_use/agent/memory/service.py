...
from app_use.agent.message_manager.service import MessageManager, time_execution_sync
from app_use.agent.message_manager.utils import time_execution_sync  # re-use util already defined
...
class Memory:
    ...
    def __init__(
        ...
        self._mem0 = Mem0Memory.from_config(config_dict=self.config.full_config_dict)
    ...
    def create_procedural_memory(self, current_step: int) -> None:
        ...
        for msg in all_messages:
            if (
                ...
                and msg.metadata.message_type in {"init", "memory"}
            ):
        ...
        from app_use.agent.message_manager.views import MessageMetadata  # local import to avoid cycles
